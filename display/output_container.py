...
class OutputContainer:
    ...
    def addOutput(self, expr: 'expression.Expression'):
        self._contents.insert(0, expr)
    
    def redraw(self, stdscr: 'curses._CursesWindow', row_start: int, col_start: int, rows: int, cols: int):
        ...
        for content in self._contents:
            ...
            print_order = [content.getInput()] + content.getOutput()
            print_order.reverse()
